...
public class ATMTier implements Tier {
    ...
    public static final ATMTier ALLOY = createTier(TagRegistry.INCORRECT_FOR_ALLOY_TOOL, 35.0F, 9001,  65.0F, 200, Ingredient.of(ModRegistry.UNOBTAINIUM_ALLTHEMODIUM_ALLOY.get()));
